...
#SBATCH --job-name=LGGM_finetuning_USA-road
#SBATCH --output=../emaitzak/iker_run_finetune_uniform_USA-road_%j.txt
#SBATCH --error=../emaitzak/iker_run_finetune_uniform_USA-road_%j_error.txt
