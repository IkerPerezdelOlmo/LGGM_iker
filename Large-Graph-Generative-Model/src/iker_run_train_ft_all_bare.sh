...
#SBATCH --output=../emaitzak/iker_finetuneAll_bare_%j.txt
#SBATCH --error=../emaitzak/iker_finetuneAll_bare_%j_error.txt
...
CONSTRUCTED_GENERAL_NAME="ft_all_wo_${DATASET}---${DATASET}-seed_uniform"
