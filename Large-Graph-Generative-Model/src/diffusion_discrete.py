    ...
    def compute_val_loss(self, pred, noisy_data, X, E, y, node_mask, test=False):
       ...
       """
        ...
        if wandb.run:
            ...
            wandb.log({f"{prefix}kl_prior": kl_prior.mean(),
                       f"{prefix}Estimator_loss_terms": loss_all_t.mean(),
                       f"{prefix}log_pn": log_pN.mean(),
                       f"{prefix}loss_term_0": loss_term_0,
                       f"{prefix}batch_nll": nll}, # Changed key to be consistent
                      commit=False)
        ##############################
        return nll
