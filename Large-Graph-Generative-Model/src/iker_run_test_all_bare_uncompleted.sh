...
DATASETS=("InternetTopology-15-N10" "InternetTopology-15-N40" "InternetTopology-50-N40" "InternetTopology-150-N100" "InternetTopology-150-N40" "InternetTopology-5-N10" "InternetTopology-500-N40" "USA-road-150-N100" "USA-road-500-N100")
...
CONSTRUCTED_GENERAL_NAME_test="all_uniform_${DATASET}_eval_tst"
...
bnd -exec python3 main.py \
    ...
    general.ckpt_path='../all_seed_uniform/checkpoints/all_seed_uniform/epoch-2749.ckpt' \
    train.batch_size=4 \
    general.setting='test' \
